// In this kata, you will write a
// function that returns the positions and the values of the "peaks" (or local maxima) of a numeric array.
...
//     function, we don 't know what is after and before and therefore, we don'
//     t know
//     if it is a peak or not).

// Also, beware of plateaus!!![1, 2, 2, 2, 1] has a peak
// while [1, 2, 2, 2, 3] and[1, 2, 2, 2, 2] do not.In
//     case
//     of a plateau - peak, please only
...
function pickPeaks(arr) {
    ...
    for (let i = 1; i < arr.length; i++) {
        ...
        if (arr[i] > arr[i - 1]) {
            ...
            if (topPos > 0) {
                objRes.pos.push(topPos)
                objRes.peaks.push(topPeak)
                topPos = 0
            }
...
//console.log(pickPeaks([1, 2, 3, 4, 5, 6, 7, 8, 9, 1, 2, 2, 2, 1]))
