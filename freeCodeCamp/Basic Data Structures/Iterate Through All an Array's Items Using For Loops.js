...
// or more elements that we might need, or to manipulate an array based on which data items meet
// a certain set of criteria. JavaScript offers several built in methods that each iterate over arrays in
// slightly different ways to achieve different results (such as every(), forEach(), map(), etc.),
...
// and returns a new array. elem represents an element that may or may not be present on one or more of the arrays
// nested within arr. Modify the function, using a for loop, to return a filtered version of the passed
