...
// or that it does not have any other arrays nested within it. Notice it contains booleans, strings, and numbers,
...
// or an array that contains other arrays. Notice that this array also contains JavaScript objects, which we will
// examine very closely in our next section, but for now, all you need to know is that arrays
...
let yourArray = [true, 228, 'niga', {bro: 'noBro'}, [6, '6', 666]]